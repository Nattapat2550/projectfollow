...
export const getIllegalById = async (req, res) => {
  try {
...
export const createIllegal = async (req, res) => {
  try {
    const data = req.body;
...
export const updateIllegal = async (req, res) => {
  try {
    const { id } = req.params;
    const data = req.body;
...
export const deleteIllegal = async (req, res) => {
  try {
    const { id } = req.params;
