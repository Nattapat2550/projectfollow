...
export function useAddressOptions<T extends Record<string, string>>(
	...
	const provinceProps: FormComboboxProps<string, T> = {
		...
		component: "combobox",
		items: provinces,
		itemToStringLabel: (provice: string) => provice,
		optionsFunc: (province: string) => ({ label: province, value: province }),
	...
	const districtProps: FormComboboxProps<AutocompleteOption, T> = {
		...
		component: "combobox",
		items: districts,
		itemToStringLabel: (districtOption: AutocompleteOption) => districtOption.value,
		optionsFunc: (option: AutocompleteOption) => ({ label: option.label, value: option }),
	...
	const subDistrictProps: FormComboboxProps<AutocompleteOption, T> = {
		...
		component: "combobox",
		items: subDistricts,
		itemToStringLabel: (subDistrictOption: AutocompleteOption) => subDistrictOption.value,
		optionsFunc: (option: AutocompleteOption) => ({ label: option.label, value: option }),
