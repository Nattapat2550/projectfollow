...
export const MOCK_DEPORTED_DATA: RepatriatedPerson[] = [
	...
	},
	{
		...
		first_name_th: "สมชาย",
		last_name_th: "ดีเลิศ",
		date_of_birth: "12/05/2535",
		national_id: "1100200011111",
		passport_id: "PP0000001",
	...
	},
	{
		...
		date_of_birth: "24/08/2540",
		national_id: "1100200022222",
		passport_id: "PP0000002",
		address: "เชียงใหม่",
		number_of_case: 1,
		number_of_warrant: 0,
		result: "SUCCESS",
	},
	{
		...
		date_of_birth: "03/01/2530",
		national_id: "1100200033333",
		passport_id: "PP0000003",
		address: "ภูเก็ต",
		number_of_case: 1,
		number_of_warrant: 0,
		result: "SUCCESS",
	},
	{
		...
		first_name_th: "อนงค์",
		last_name_th: "งดงาม",
		date_of_birth: "15/11/2543",
		national_id: "1100200044444",
		passport_id: "PP0000004",
		address: "ชลบุรี",
		number_of_case: 1,
		number_of_warrant: 0,
		result: "SUCCESS",
	},
	{
		...
		date_of_birth: "30/07/2538",
		national_id: "1100200055555",
		passport_id: "PP0000005",
		address: "ขอนแก่น",
		number_of_case: 1,
		number_of_warrant: 0,
		result: "SUCCESS",
...
export const MOCK_ILLEGAL_DATA: IllegalImmigrant[] = [
	...
	},
	{
		...
		address: "ตาก (ตรวจพบที่ชายแดน)",
		national_id: "0-8401-XXXXX-11-0",
		date_of_birth: "01/02/2542",
		passport_id: "PP-ILL01",
	},
	{
		id: "mock-ill-2",
		first_name_th: "ซู",
		...
		address: "ระนอง (ตรวจพบที่ท่าเรือ)",
		national_id: "0-8401-XXXXX-22-0",
		date_of_birth: "18/06/2545",
		passport_id: "PP-ILL02",
	},
	{
		id: "mock-ill-3",
		first_name_th: "จัน",
		...
		address: "สระแก้ว (ตรวจพบในพื้นที่เกษตร)",
		national_id: "0-8401-XXXXX-33-0",
		date_of_birth: "22/12/2539",
		passport_id: "PP-ILL03",
	},
	{
		id: "mock-ill-4",
		first_name_th: "มิน",
		...
		address: "กาญจนบุรี",
		national_id: "0-8401-XXXXX-44-0",
		date_of_birth: "09/09/2533",
		passport_id: "PP-ILL04",
	},
	{
		id: "mock-ill-5",
		first_name_th: "เทือง",
		...
		address: "สงขลา",
		national_id: "0-8401-XXXXX-55-0",
		date_of_birth: "14/04/2541",
		passport_id: "PP-ILL05",
	},
];
